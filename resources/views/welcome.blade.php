...
<body
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                class="text-[15px] lg:text-[16px] leading-[24px] flex-1 p-6 pb-12 lg:p-20
    ...
    rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                ...
                {{-- JUDUL --}}
                <h1 class="mb-3 font-semibold text-[22px] lg:text-[24px] leading-[30px]">
                    PELATIHAN SISTEM INFORMASI PENGELOLAN DANA DESA
                </h1>

                {{-- DESKRIPSI --}}
                <p class="mb-5 text-[#706f6c] dark:text-[#A1A09A] leading-[26px]">
                    Kegiatan pelatihan ini diselenggarakan di
                    <strong>Desa Kandangmas, Kabupaten Kudus</strong>
                    sebagai upaya meningkatkan pemahaman dan keterampilan perangkat desa dalam
                    pengelolaan Dana Desa berbasis sistem informasi.
                </p>

                {{-- MATERI / TUJUAN --}}
                <ul class="flex flex-col mb-6 gap-2">
                    <li
                        class="flex items-start gap-4 py-2 relative before:border-l
            before:border-[#e3e3e0] dark:before:border-[#3E3E3A]
            before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute">
                    ...
                    shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)]
                    w-4 h-4 border dark:border-[#3E3E3A] border-[#e3e3e0]">
                                <span class="rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A] w-2 h-2"></span>
                            </span>
                        </span>

                        <span class="leading-[26px]">
                            Pengenalan alur <strong>RAB, DPA, SPP, Pembayaran, dan Laporan</strong> Dana Desa
                        </span>
                    </li>
                    ...
                    <li
                        class="flex items-start gap-4 py-2 relative before:border-l
            before:border-[#e3e3e0] dark:before:border-[#3E3E3A]
            before:bottom-1/2 before:top-0 before:left-[0.4rem] before:absolute">
                    ...
                    w-4 h-4 border dark:border-[#3E3E3A] border-[#e3e3e0]">
                        ...
                        <span class="leading-[26px]">
                            Praktik penggunaan aplikasi Sistem Informasi Pengelolaan Dana Desa
                        </span>
                    </li>
                </ul>

                {{-- AKSI --}}
                <ul class="flex gap-3 text-[15px] lg:text-[16px]">
                    <li>
                        <a href="/login"
                            class="inline-block px-6 py-2 rounded-sm border
                bg-[#1b1b18] text-white border-black
                hover:bg-black hover:border-black
                dark:bg-[#eeeeec] dark:border-[#eeeeec] dark:text-[#1C1C1A]
